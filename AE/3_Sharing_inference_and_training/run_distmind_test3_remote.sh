...
python ./source/py_utils/launch_remote.py --launch_part create_dir  --log_dir $PRIFIX/distmind --test_index 3
sleep 5
...
python ./source/py_utils/launch_remote.py --launch_part dist_storage --test_index 3 --log_file $PRIFIX/distmind/log_storage.txt
...
python ./source/py_utils/launch_remote.py --launch_part dist_server --test_index 3 --n_models $GLOBAL_NUM_MODELS --model_seed res --system_type distmind 
...
setsid python build/bin/client_max_inference.py $CONTROLLER_IP $CONTROLLER_PORT $LOAD_BALANCER_IP $LOAD_BALANCER_PORT 0 > $PRIFIX/distmind/log_client.txt 2>&1 &
