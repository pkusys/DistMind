...
python ./source/py_utils/launch_remote.py --launch_part mps_server --test_index 3 --model_seed res --n_models $GLOBAL_NUM_MODELS --training-log-dir "../../$PRIFIX/mps/training_logs"
