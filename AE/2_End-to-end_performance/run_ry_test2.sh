...
run_experiment() {
    ...
    # Step2 : run server
    echo "Running server..."
    setsid python ./source/ray_benchmark/pt_example.py --n_gpus $WORLD_SIZE --n_model_variants $GLOBAL_NUM_MODELS --model_name res > tmp/test2/ray/zipf${zipf}_resched${resched}/log_server.txt 2>&1 &
    PID_SERVER=$!
